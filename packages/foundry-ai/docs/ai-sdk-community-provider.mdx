...
These tables reflect the latest checked-in live capability matrix snapshot. `-` means the capability is intentionally not asserted or is out of scope for the current stack.
...
| `gpt-5.1-codex` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | - | - |
...
| `gpt-5-codex` | <Cross size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | - | - |
...
| `o3` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
...
| `claude-opus-4.1` | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> | <Cross size={18} /> | <Cross size={18} /> | <Cross size={18} /> |
| `claude-sonnet-4` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> |
| `claude-opus-4` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> | <Cross size={18} /> | <Cross size={18} /> |
...
| `gemini-2.5-pro` | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> | <Check size={18} /> | <Check size={18} /> | - |
...
These tables summarize the latest checked-in live snapshot. For row-level notes and durations, see the full live capability matrix.
