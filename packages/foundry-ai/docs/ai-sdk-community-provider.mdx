---
title: Foundry AI
description: Learn how to use @shpit/foundry-ai to access Palantir Foundry LLM proxy endpoints from the AI SDK.
---

# Foundry AI

The [`@shpit/foundry-ai`](https://www.npmjs.com/package/@shpit/foundry-ai) community provider routes AI SDK language-model and OpenAI embedding requests through Palantir Foundry's provider-compatible proxy endpoints.
...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @shpit/foundry-ai ai @ai-sdk/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @shpit/foundry-ai ai @ai-sdk/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @shpit/foundry-ai ai @ai-sdk/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @shpit/foundry-ai ai @ai-sdk/openai" dark />
  </Tab>
</Tabs>
...
- `@shpit/foundry-ai/anthropic`
- `@shpit/foundry-ai/google`
...
The OpenAI provider supports `text-embedding-3-small`, `text-embedding-3-large`, and raw Foundry RIDs. Anthropic and Google embeddings remain unsupported.
