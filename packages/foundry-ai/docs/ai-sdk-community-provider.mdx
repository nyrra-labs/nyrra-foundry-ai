...
The [`@shpit/foundry-ai`](https://www.npmjs.com/package/@shpit/foundry-ai) community provider routes AI SDK language-model requests through Palantir Foundry's provider-compatible proxy endpoints.
