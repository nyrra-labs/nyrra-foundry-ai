...
const requiredFiles = [
  ...
  'skills/foundry-ai-provider/references/examples/example-config.ts',
  'skills/foundry-ai-provider/references/examples/example-logger.ts',
  'skills/foundry-ai-provider/references/examples/example-model.ts',
  'skills/foundry-ai-provider/references/examples/example-tools.ts',
